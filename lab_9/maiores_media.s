#Tarefa: lê num N
#MaioresMedia(int v*, int N) -> retorna qnts sao maiores q a media
...
main:
    ...
    call MaioresMedia #retorna qnt de num maiores q a media em a0
...
MaioresMedia:
    ...
    #guarda valor da media
    la a0, vetor
    li a1, 2

    mv s0, a0 #movendo vetor p t0
    mv s1, a1 #movendo qnt num p a1

    call Media 
    mv t3, a0
    
    li t0, 0 #meu contador

    contagem:

    lbu t1, 0(s0)
    #compara tds os valores do vetor c ele
    bltu  t1, t3, contagem #se for menor ou igual a media eu nao conto
    addi t0, t0, 1 #conto
